...
angular.module("angular-carousel", ["ngTouch", "angular-carousel.shifty"]), angular.module("angular-carousel").directive("rnCarouselAutoSlide", ["$interval", function (a) {
    ...
    a.put("carousel-indicators.html", '<div class="rn-carousel-indicator">\n<span ng-repeat="slide in slides" ng-class="{active: $index==index}" ng-click="goToSlide($index)" style="margin:3px;">▁</span></div>')
}]), function () {
    "use strict";
        ...
        return {
            restrict: "A", scope: !0, compile: function (m, n) {
                ...
                return ["ng-repeat", "data-ng-repeat", "ng:repeat", "x-ng-repeat"].every(function (a) {
                    ...
                    function v(a) {
                        O = !0, E({x: a.clientX, y: a.clientY}, a)
                    }
                    ...
                    function E(a, b, c) {
                        if ((!b || O) && (B(), H = !1, O = !1, J = I - a.x, 0 !== J && !T))if (N += 100 * -J / Q, L.isSequential) {
                            var e = L.moveTreshold * Q, f = -J, g = -Math[f >= 0 ? "ceil" : "floor"](f / Q), h = Math.abs(f) > e;
                    ...
                    "true" !== q.rnSwipeDisabled && a.bind(o, {
                        start: C, move: D, end: E, cancel: function (a) {
                            E({}, a)
                        }
                    ...
                    if (q.rnCarouselIndex) {
                        ...
                        angular.isFunction(_.assign) ? (m.$watch("carouselIndex", function (a) {
                            ...
                            void 0 !== a && null !== a && (P && P.length > 0 && a >= P.length ? (a = P.length - 1, $(a)) : P && 0 > a && (a = 0, $(a)), T || x(a, {animate: !U}), U = !1)
                        }), M = !0, L.defaultIndex && x(L.defaultIndex, {animate: !U})) : isNaN(q.rnCarouselIndex) || x(parseInt(q.rnCarouselIndex, 10), {animate: !1})
                    } else x(L.defaultIndex, {animate: !U}), U = !1;
                    if (q.rnCarouselLocked && m.$watch(q.rnCarouselLocked, function (a, b) {
                        ...
                        m[aa ? "$watch" : "$watchCollection"](p, function (a, b) {
                            if (P = a, aa && angular.isArray(a)) {
                                var c = b[m.carouselIndex], d = k(a, c, m.carouselIndex);
                                x(d, {animate: !1})
                            } else x(m.carouselIndex, {animate: !1})
                        }, !0)
                    }
